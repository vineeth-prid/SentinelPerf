...
**Environment:** test  
**Generated:** 2025-12-23 10:02:06 UTC  
...
The system reached its **breaking point at 22 virtual users** (24.4 requests/second), where error_rate_breach exceeded acceptable thresholds.
...
- Observed: 0.1314, Threshold: 0.0500
- Severity: 2.63x threshold
- Error rate: 13.14%
- P95 latency: 685.1ms
- Throughput: 24.4 RPS
...
| t5 | 🔴 error_rate_breach | adaptive_22vus | 22 | Error rate crossed threshold (13.1% > 5.0%) |
| t6 | 🟠 latency_degradation | adaptive_22vus | 22 | Latency slope changed (19.2x increase) |
| t7 | 🟠 latency_degradation | adaptive_22vus | 22 | Latency exceeded threshold (685ms > 200ms) |
| t8 | 🟡 throughput_plateau | adaptive_22vus | 22 | Throughput plateaued (expected 14.7%, got -2.4%) |
...
Error rate exceeded threshold causing cascading failures at 22 VUs (24.4 RPS)
...
**Rationale:** Errors cascaded causing system collapse (detected at 22 VUs, 24.4 RPS via error_rate_breach)
...
|-----------|-----|----------|----------|------------|-------------|------------|
| adaptive_2vus | 2 | 11s | 30 | 0.00% | 36ms | 2.9 RPS |
| adaptive_7vus | 7 | 11s | 117 | 0.00% | 36ms | 11.1 RPS |
| adaptive_12vus | 12 | 11s | 181 | 0.55% | 36ms | 17.5 RPS |
| adaptive_17vus | 17 | 11s | 258 | 0.00% | 36ms | 25.0 RPS |
| adaptive_22vus | 22 | 12s | 274 | 13.14% | 685ms | 24.4 RPS |
...
|--------|-------|
| Max VUs Reached | 22 |
| Max Sustained RPS | 25.0 |
| Total Requests Executed | 860 |
